...
4. Treat `main` as the 0.3.7 Google Play preparation milestone until a named,
   signed release is approved. Changed distributable bytes require a new Android
   version code; do not rename an old-version APK and present it as an update.
